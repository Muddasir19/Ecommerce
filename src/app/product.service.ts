...
export class ProductService {
  ...
  laptops = [
    {
      type: 'Laptop',
      image: '/l1.avif', // replace with actual image URL
      price: '$1200',
      description:
    ...
    {
      type: 'Laptop',
      image: '/l2.avif', // replace with actual image URL
      price: '$1000',
      description:
  ...
  computers = [
    {
      type: 'Computer',
      image: '/c1.avif', // replace with actual image URL
      price: '$1500',
      description:
    ...
    {
      type: 'Computer',
      image: '/c2.avif', // replace with actual image URL
      price: '$2000',
      description:
    ...
    {
      type: 'Computer',
      image: '/c3.avif', // replace with actual image URL
      price: '$1000',
      description: 'Office desktop with Intel i5, 16GB RAM, and 512GB SSD.',
    },
    {
      type: 'Computer',
      image: '/c4.avif', // replace with actual image URL
      price: '$2500',
      description:
    ...
    {
      type: 'Computer',
      image: '/c5.webp', // replace with actual image URL
      price: '$850',
  ...
  mobiles = [
    {
      type: 'Mobile',
      image: '/m1.avif', // replace with actual image URL
      price: '$800',
      description:
    ...
    {
      type: 'Mobile',
      image: '/m2.avif', // replace with actual image URL
      price: '$950',
      description:
    ...
    {
      type: 'Mobile',
      image: '/m3.avif', // replace with actual image URL
      price: '$1200',
      description:
    ...
    {
      type: 'Mobile',
      image: '/m4.avif', // replace with actual image URL
      price: '$500',
      description:
    ...
    {
      type: 'Mobile',
      image: '/m5.webp', // replace with actual image URL
      price: '$650',
      description:
